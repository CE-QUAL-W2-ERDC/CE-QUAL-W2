...
! Title and array dimensions
  ...
  READ (CON,'(//8X,I8,8A8,f8.0,2a8)')  NOD,SELECTC,HABTATC,ENVIRPC,AERATEC,inituwl,ORGCC,SED_DIAG,DZMAX,HGMOD,wdz_multiMOD
  ELSE
  READ (CON,*)
  READ (CON,*)
  READ (CON,*)
  ...
  READ (CON,*)
  READ (CON,*)
  READ (CON,*) NOD,SELECTC,HABTATC,ENVIRPC,AERATEC,INITUWL,ORGCC,SED_DIAG,DZMAX,HGMOD,wdz_multiMOD
  SELECTC=ADJUSTR(SELECTC);HABTATC=ADJUSTR(HABTATC);ENVIRPC=ADJUSTR(ENVIRPC);AERATEC=ADJUSTR(AERATEC);INITUWL=ADJUSTR(INITUWL)
  ORGCC = ADJUSTR(ORGCC); SED_DIAG=ADJUSTR(SED_DIAG); HGMOD=ADJUSTR(HgMOD); wdz_multiMOD=ADJUSTR(wdz_multiMOD)
  ENDIF
...
! Derived variables
  ...
  PHG2L_DER=28;PHG2S_DER=29;PMHGL_DER=30;PMHGS_DER=31;DHG2_DER=32;DMHG_DER=33;HG2ALG_DER=34;HG2ZOO_DER=35;
  HG2ISS_DER=36;HG2POM_DER=37;METHYL_DER=38;DEMETHYL_DER=39;MEHGALG_DER=40;MEHGZOO_DER=41;
  MEHGISS_DER=42;MEHGPOM_DER=43;JOC_DER=44
